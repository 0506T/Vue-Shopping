  ...
  <div class="prodetail">
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in cocumentList" :key="item.comment_id">
          <div class="top">
    ...
    <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立刻购买'">
      <div class="product">
        ...
        <div class="num-box">
          ...
          <ContBox v-model="addCount"></ContBox>
        </div>
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      const { data } = await this.addCart(this.goodsId, this.addCount, this.detail.skuList[0].goods_sku_id)
